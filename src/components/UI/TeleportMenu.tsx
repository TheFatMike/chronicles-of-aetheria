    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-100 flex items-center justify-center pointer-events-none">
        <motion.div
          ...
          style={{ scale: uiScale }}
          className="w-[500px] bg-aetheria-950/95 border-4 border-aetheria-800 rounded-2xl shadow-aetheria-lg overflow-hidden flex flex-col max-h-[80vh] pointer-events-auto backdrop-blur-sm"
        >
          {/* Header */}
          <div className="p-8 bg-linear-to-b from-purple-900/20 to-transparent border-b border-aetheria-800/50 relative">
            ...
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h2 className="text-2xl font-black text-aetheria-200 uppercase tracking-widest">Etheria Network</h2>
                  <div className="flex items-center gap-2">
                    <div className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse" />
                    <p className="text-[10px] text-aetheria-600 font-black uppercase tracking-widest">
              ...
              <button
                ...
                className="p-2 rounded-xl bg-black/40 border border-aetheria-800 text-aetheria-600 hover:text-white transition-all"
              >
                <X size={20} />
              </button>
            </div>
          ...
          <div className="flex-1 overflow-y-auto p-6 custom-scrollbar space-y-4">
            <div className="flex items-center justify-between px-2">
              <span className="text-[10px] text-aetheria-600 font-black uppercase tracking-[0.2em]">Available Conduits</span>
            ...
            {destinations.length === 0 ? (
              <div className="py-20 flex flex-col items-center justify-center text-center space-y-4 opacity-40">
                <Navigation size={48} className="text-aetheria-600" />
                <div className="space-y-1">
                  <p className="text-xs font-black uppercase tracking-widest text-aetheria-200">No Other Crystals Found</p>
                  <p className="text-[10px] font-bold text-aetheria-600 max-w-[200px]">
              ...
              <div className="grid grid-cols-1 gap-3">
                {destinations.map(dest => (
                  <button
                    ...
                    className="group relative flex items-center justify-between p-5 bg-black/40 border-2 border-aetheria-800/50 rounded-2xl transition-all hover:bg-purple-500/5 hover:border-purple-500/30 disabled:opacity-50 disabled:hover:bg-transparent disabled:hover:border-aetheria-800/50 overflow-hidden"
                  >
                    <div className="flex items-center gap-4 relative z-10">
                      ...
                      <div className="text-left">
                        <h4 className="text-[13px] font-black text-aetheria-200 uppercase tracking-wider group-hover:text-purple-300 transition-colors">
                          {dest.name || "Unnamed Crystal"}
                        </h4>
                        <p className="text-[9px] text-aetheria-600 font-bold uppercase tracking-widest">
                    ...
                    <div className="flex flex-col items-end gap-1 relative z-10">
                      <div className="flex items-center gap-1.5 bg-black/60 px-3 py-1.5 rounded-xl border border-aetheria-800">
                        <Coins size={12} className="text-amber-500" />
          ...
          {/* Footer */}
          <div className="p-6 bg-black/60 border-t border-aetheria-800 flex items-center justify-center gap-3">
            <div className="w-1.5 h-1.5 rounded-full bg-purple-500 animate-pulse" />
            <span className="text-[9px] text-aetheria-600 font-black uppercase tracking-[0.3em]">Conduit Stabilization Active</span>
          </div>
        </motion.div>
      </div>
    </AnimatePresence>
